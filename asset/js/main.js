...
let rankTitle = ""
let rankHtml = ""
rankNameList.forEach(function(rank,rankIdx){
    rankTitle = `<p class="rank-title">랭킹</p>`
    rankHtml +=  `
    <div class="rank-list">
    <span class="rank">${rankIdx+1}등</span>
    <p class="name">${rank.name}</p>
    <span class="point">${rank.temp}°</span>
    </div>
    `;
    // console.log(rankTitle+rankHtml)
})
console.log(rankTitle+rankHtml);

document.querySelector(".group-rank").innerHTML = rankTitle+rankHtml
